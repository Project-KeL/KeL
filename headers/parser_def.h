...
#define SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_TYPE 1
#define MASK_BIT_NODE_SUBTYPE_IDENTIFICATION_TYPE (1 << SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_TYPE)
...
#define SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_SCOPED 2
#define MASK_BIT_NODE_SUBTYPE_IDENTIFICATION_SCOPED (1 << SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_SCOPED)

typedef enum: uint64_t {
#define NODE_SUBTYPE_IDENTIFICATION(subtype) NodeSubtypeIdentificationBitScoped_ ## subtype
	NODE_SUBTYPE_IDENTIFICATION(FALSE) = 0b0 << SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_SCOPED,
	NODE_SUBTYPE_IDENTIFICATION(TRUE) = 0b1 << SHIFT_BIT_NODE_SUBTYPE_IDENTIFICATION_SCOPED,
#undef NODE_SUBTYPE_IDENTIFICATION
